{
    ...
    inputs = {
        nixpkgs-proxy.url = "git+https://gh-proxy.org/https://github.com/NixOS/nixpkgs.git?ref=nixos-unstable&shallow=1";
        ...
        flake-utils-proxy.url = "git+https://gh-proxy.org/https://github.com/numtide/flake-utils.git?ref=main&shallow=1";

        winapps-proxy.url = "git+https://gh-proxy.org/https://github.com/winapps-org/winapps.git?ref=main&shallow=1";
